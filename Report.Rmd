...
- **The current year's `r ifelse(dta.cumsum[num.months,2] - dta.cumsum[num.months, 3] > 0, "surplus", "deficit")` is £`r as.numeric(dta.cumsum[num.months,2] - dta.cumsum[num.months,3])`**.
