...
The Members' Exhibition made a loss of £`r -as.numeric(members_dta[nrow_mbs, "Income"] - members_dta[nrow_mbs, "Expenditure"])`.
...
```
Note: payments of £1,500 to the exhibition organisers, £2,300 to artists, and approximately £1,300 to St John's College are still outstanding, so the final surplus generated by the Open Exhibition should be around £5,000.